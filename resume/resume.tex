...
\begin{document}
	...
	\begin{rSection}{P}{rojects}
		\begin{rSectionEntry}{Project Team Lead}{September 2025 - Present}{ThinkStack}{East Lansing, MI}
			...
			\item Developed a REST API using FastAPI, SQLAlchemy, MongoDB, and Neo4j to handle authentication, manage user data, efficiently store and query notes, and visualize relationships between concepts, text blocks, and environments
	...
	\begin{rSection}{L}{eadership \& Awards}
		\begin{rSectionEntry}{Interactive Media Track Winner}{February 2025}{SpartaHackX}{\href{https://devpost.com/software/wizviz}{Devpost Link}}
		...
		\begin{rSectionEntry}{Vice President}{September 2025 - Present}{Claude Builders Club @ MSU}{East Lansing, MI}
			\item Planning and executing workshops, projects, and lectures to encourage use of AI tools like Claude Code and Codex
			\item Secured funding partnerships with Anthropic and fostered active and engaged participation among 150+ students
		\end{rSectionEntry}
	\end{rSection}
